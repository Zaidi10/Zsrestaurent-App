...
import { Nav, Navbar, NavbarBrand, NavbarToggler, Collapse, NavItem, Jumbotron, Modal, ModalBody, ModalHeader, Form, FormGroup, Label, Input, Button } from 'reactstrap';
...
export default class Header extends Component {
    ...
    handleKeypress(e, input, def) {
        console.log(e.keyCode);
        if (e.keyCode === 8) {
            this.setState({ [input]: def });
            console.log(input);
            console.log(def);
            e.preventDefault();
        }
